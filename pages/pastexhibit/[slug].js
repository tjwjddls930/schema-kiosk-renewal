...
export default function Viewpage() {
    ...
    return(
        ...
        {data && (
            ...
            {popup && (
                <div className={clsx(isPortrait ? "absolute bg-Ablack bg-opacity-40 h-[91%] w-[600px] bottom-16 screen-w:h-[97%] screen-w:w-[1500px] screen-w:bottom-28 left-1/2 transform -translate-x-1/2" : "absolute bg-Ablack bg-opacity-40 h-[91%] w-[600px] bottom-16 screen-w:h-[94%] screen-w:w-[1700px] screen-w:bottom-28 left-1/2 transform -translate-x-1/2")}
                ...
                >
                    <div className={clsx(isPortrait ? "w-5/6 h-5/6 flex flex-col space-y-32 screen-w:space-y-[650px] px-4 mt-16 screen-w:px-8 screen-w:mt-48 mx-auto items-center justify-end text-center" : "w-5/6 flex flex-col space-y-32 screen-w:space-y-[650px] px-4 mt-16 screen-w:px-8 screen-w:mt-48 mx-auto items-center justify-center text-center")}>
                        ...
                        <div className="flex flex-col space-y-2 mx-auto w-full screen-w:space-y-4">
                            ...
                            <span className="text-Dgrey font-bold text-base screen-w:text-3xl">{'확대해서 그림을 더 자세히 감상해보세요!'}</span>
                        </div>
                        <div className="flex flex-col w-full mx-auto">
                            <div className="flex justify-between w-full">
                                <div className="flex flex-col space-y-2">
                                    <span className="font-bold text-Awhite text-lg screen-w:text-3xl">{data.name}</span>
                                    <span className="font-bold text-Awhite text-base screen-w:3xl">{data.overview}</span>
                                    <span className="font-bold text-Awhite text-base screen-w:3xl">{data.overview1}</span>
                                </div>

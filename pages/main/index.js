            ...
            >
                ...
                >
                    <div className="flex flex-col">
                        <div className="border-4 border-Cpurple rounded-full w-20 h-20 2xl:w-28 2xl:h-28 items-center bg-Awhite mx-auto">
                            <Image 
                        ...
                        <div className="flex flex-col h-3/4 w-3/4 items-center mx-auto bg-Awhite rounded-lg z-20 mt-20 space-y-4 2xl:space-y-6">
                            ...
                            <div className="flex flex-col space-y-6 w-full h-[700px] 2xl:space-y-18 2xl:h-full bg-Cpurple bg-opacity-30 rounded-b-lg py-6 2xl:pt-32 z-30">
                                ...
                                <div className="flex flex-row mx-auto space-x-6 2xl:space-x-8 z-40">
                                    <button className="h-12 w-[200px] 2xl:h-16 2xl:w-[250px] z-40 bg-Awhite shadow-lg rounded-full text-black font-bold text-xl 2xl:text-xl"
                                        onClick={()=>setModal(!modal)}
                                    >
                                        취소하기
                                    </button>
                                    {/* 언어 변경 버튼 */}
                                    <button 
                                        className="h-12 w-[200px] 2xl:h-16 2xl:w-[250px] z-40 bg-gradient-to-r from-Agradient to-Bgradient shadow-lg rounded-full text-white font-bold text-xl 2xl:text-xl"
                                        onClick={
                                            ()=> changeLanguage(id)
                                        }
                                    >

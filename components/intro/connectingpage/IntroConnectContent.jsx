...
const structureButton = {
    KOR: (size) => (
        <div className="flex flex-col w-[170px] screen-w:w-[60%] screen-w:space-y-6 pt-10 justify-start">
            ...
            <span className="text-base screen-w:text-4xl text-Agrey font-bold">{'Art museum Introduction and Structure'}</span>
            <span className={`text-base text-Ablack font-bold mb-5 ${size ? `screen-w:text-6xl` : `screen-w:text-5xl`}`}>{"미술관 소개 및 구조"}</span>
    ...
    ENG: (size) => (
        <div className="flex flex-col w-[170px] screen-w:w-[60%] screen-w:space-y-6 pt-10 justify-start">
            <div className="bg-Cpurple h-[1px] w-[70px]" />
            <span className="text-base screen-w:text-4xl text-Agrey font-bold">{'Art museum Introduction and Structure'}</span>
            <span className={`text-base text-Ablack font-bold mb-5 ${size ? `screen-w:text-6xl` : `screen-w:text-5xl`}`}>{"Art Museum introduction and structure"}</span>
    ...
    CH: (size) => (
        <div className="flex flex-col w-[170px] screen-w:w-[60%] screen-w:space-y-6 pt-10 justify-start">
            <div className="bg-Cpurple h-[1px] w-[70px]" />
            <span className="text-base screen-w:text-4xl text-Agrey font-bold">{'Art museum Introduction and Structure'}</span>
            <span className={`text-base text-Ablack font-bold mb-5 ${size ? `screen-w:text-6xl` : `screen-w:text-5xl`}`}>{"博物馆简介及结构"}</span>
    ...
    TH: (size) => (
        <div className="flex flex-col w-[170px] screen-w:w-[60%] screen-w:space-y-6 pt-10 justify-start">
            <div className="bg-Cpurple h-[1px] w-[70px]" />
            <span className="text-base screen-w:text-4xl text-Agrey font-bold">{'Art museum Introduction and Structure'}</span>
            <span className={`text-base text-Ablack font-bold mb-5 ${size ? `screen-w:text-6xl` : `screen-w:text-5xl`}`}>{"การแนะนำและโครงสร้างของพิพิธภัณฑ์"}</span>
    ...
    VI: (size) => (
        <div className="flex flex-col w-[170px] screen-w:w-[60%] screen-w:space-y-6 pt-10 justify-start">
            <div className="bg-Cpurple h-[1px] w-[70px]" />
            <span className="text-base screen-w:text-4xl text-Agrey font-bold">{'Art museum Introduction and Structure'}</span>
            <span className={`text-base text-Ablack font-bold mb-5 ${size ? `screen-w:text-6xl` : `screen-w:text-5xl`}`}>{"Giới thiệu và cấu trúc bảo tàng"}</span>
...
const careerButton = {
    KOR: (size) => (
        <div className="flex flex-col w-[170px] screen-w:w-[60%] screen-w:space-y-6 pt-10 justify-start">
            <div className="bg-Cpurple h-[1px] w-[70px]" />
            <span className="text-base screen-w:text-4xl text-Agrey font-bold">{'Kim Jae-Kwan`s major career'}</span>
            <span className={`text-base text-Ablack font-bold mb-5 ${size ? `screen-w:text-6xl` : `screen-w:text-5xl`}`}>{"김재관 주요 경력"}</span>
    ...
    ENG: (size) => (
        <div className="flex flex-col w-[170px] screen-w:w-[60%] screen-w:space-y-6 pt-10 justify-start">
            <div className="bg-Cpurple h-[1px] w-[70px]" />
            <span className="text-base screen-w:text-4xl text-Agrey font-bold">{'Kim Jae-Kwan`s major career'}</span>
            <span className={`text-base text-Ablack font-bold mb-5 ${size ? `screen-w:text-6xl` : `screen-w:text-5xl`}`}>{"Kim Jae-Kwan's Major Career"}</span>
    ...
    CH: (size) => (
        <div className="flex flex-col w-[170px] screen-w:w-[60%] screen-w:space-y-6 pt-10 justify-start">
            <div className="bg-Cpurple h-[1px] w-[70px]" />
            <span className="text-base screen-w:text-4xl text-Agrey font-bold">{'Kim Jae-Kwan`s major career'}</span>
            <span className={`text-base text-Ablack font-bold mb-5 ${size ? `screen-w:text-6xl` : `screen-w:text-5xl`}`}>{"Jaegwan Kim 主要职业经历"}</span>
    ...
    TH: (size) => (
        <div className="flex flex-col w-[170px] screen-w:w-[60%] screen-w:space-y-6 pt-10 justify-start">
            <div className="bg-Cpurple h-[1px] w-[70px]" />
            <span className="text-base screen-w:text-4xl text-Agrey font-bold">{'Kim Jae-Kwan`s major career'}</span>
            <span className={`text-base text-Ablack font-bold mb-5 ${size ? `screen-w:text-6xl` : `screen-w:text-5xl`}`}>{"ประสบการณ์การทำงานระดับเมเจอร์ของแจกวาน คิม"}</span>
    ...
    VI: (size) => (
        <div className="flex flex-col w-[170px] screen-w:w-[60%] screen-w:space-y-6 pt-10 justify-start">
            <div className="bg-Cpurple h-[1px] w-[70px]" />
            <span className="text-base screen-w:text-4xl text-Agrey font-bold">{'Kim Jae-Kwan`s major career'}</span>
            <span className={`text-base text-Ablack font-bold mb-5 ${size ? `screen-w:text-6xl` : `screen-w:text-5xl`}`}>{"Jaegwan Kim Kinh nghiệm nghề nghiệp chính"}</span>
...
const awardButton = {
    KOR: (size) => (
        <div className="flex flex-col w-[170px] screen-w:w-[60%] screen-w:space-y-6 pt-10 justify-start">
            <div className="bg-Cpurple h-[1px] w-[70px]" />
            <span className="text-base screen-w:text-4xl text-Agrey font-bold">{'Schema International Prized for Art'}</span>
            <span className={`text-base text-Ablack font-bold mb-5 ${size ? `screen-w:text-6xl` : `screen-w:text-5xl`}`}>{"쉐마국제미술상"}</span>
    ...
    ENG: (size) => (
        <div className="flex flex-col w-[170px] screen-w:w-[60%] screen-w:space-y-6 pt-10 justify-start">
            <div className="bg-Cpurple h-[1px] w-[70px]" />
            <span className="text-base screen-w:text-4xl text-Agrey font-bold">{'Schema International Prized for Art'}</span>
            <span className={`text-base text-Ablack font-bold mb-5 ${size ? `screen-w:text-6xl` : `screen-w:text-5xl`}`}>{"Schema International Award For Art"}</span>
    ...
    CH: (size) => (
        <div className="flex flex-col w-[170px] screen-w:w-[60%] screen-w:space-y-6 pt-10 justify-start">
            <div className="bg-Cpurple h-[1px] w-[70px]" />
            <span className="text-base screen-w:text-4xl text-Agrey font-bold">{'Schema International Prized for Art'}</span>
            <span className={`text-base text-Ablack font-bold mb-5 ${size ? `screen-w:text-6xl` : `screen-w:text-5xl`}`}>{"舍玛国际艺术奖"}</span>
    ...
    TH: (size) => (
        <div className="flex flex-col w-[170px] screen-w:w-[60%] screen-w:space-y-6 pt-10 justify-start">
            <div className="bg-Cpurple h-[1px] w-[70px]" />
            <span className="text-base screen-w:text-4xl text-Agrey font-bold">{'Schema International Prized for Art'}</span>
            <span className={`text-base text-Ablack font-bold mb-5 ${size ? `screen-w:text-6xl` : `screen-w:text-5xl`}`}>{"รางวัลศิลปะนานาชาติเชมา"}</span>
    ...
    VI: (size) => (
        <div className={`flex flex-col w-[170px] screen-w:w-[60%] screen-w:space-y-6 pt-10 justify-start`}>
            <div className="bg-Cpurple h-[1px] w-[70px]" />
            <span className="text-base screen-w:text-4xl text-Agrey font-bold">{'Schema International Prized for Art'}</span>
            <span className={`text-base text-Ablack font-bold mb-5 ${size ? `screen-w:text-6xl` : `screen-w:text-5xl`}`}>{"Giải thưởng nghệ thuật quốc tế Shema"}</span>
                ...
                <div className="h-[60%] w-5/6 mx-auto">
                    <div className="flex flex-row h-full space-x-4 justify-start screen-w:space-x-6 screen-w:justify-center">
                        ...
                        <div className="flex flex-col-reverse pb-8">
                            <img 
                                className={clsx(isPortrait ? "h-12 w-12 screen-w:h-24 screen-w:w-24" : "h-12 w-12 screen-w:h-24 screen-w:w-28")}

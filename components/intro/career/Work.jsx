    ...
    return(
        <div className={clsx(isPortrait ? "": "p-6 screen-w:px-6 screen-w:pt-20 mx-auto items-center z-10")}>
            <div className="w-11/12 h-5/6 flex flex-row mx-auto space-x-16">
                ...
                <div className="w-[40%] h-[1400px] flex flex-col space-y-16 mx-auto overflow-auto">
                    <span className="font-bold text-6xl text-Ablack text-center">{titleText[language]}</span>

...
const mainText = {
    KOR: (font) => (
        <p className={clsx("text-Ablack h-[400px] screen-w:h-[1000px] overflow-auto", font ? "text-base screen-w:text-[52px] screen-w:leading-relaxed" : "text-sm screen-w:text-5xl screen-w:leading-normal")}>
    ...
    ENG: (font) => (
        <p className={clsx("text-Ablack h-[400px] screen-w:h-[1000px] overflow-auto leading-relaxed", font ? "text-base screen-w:text-[52px] screen-w:leading-relaxed" : "text-sm screen-w:text-5xl screen-w:leading-normal")}>
    ...
    return(
        <div className={clsx(isPortrait ? "": "p-6 screen-w:px-6 screen-w:pt-20 mx-auto items-center z-10")}>
            <div className="w-11/12 h-5/6 flex flex-row mx-auto space-x-16">
                ...
                <div className="w-[40%] h-[400px] screen-w:h-[1400px] flex flex-col space-y-16 mx-auto">

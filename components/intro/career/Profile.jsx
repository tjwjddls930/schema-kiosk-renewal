...
const pageCareer = {
    ...
    ENG: () => (
        <div className="border-4 border-Ablack w-[300px] h-[150px] flex flex-col space-y-2 px-4 py-8 text-center screen-w:w-[800px] screen-w:h-[450px] screen-w:px-8 screen-w:py-16 text-Ablack text-xs screen-w:text-4xl font-bold">
    ...
    TH: () => (
        <div className="border-4 border-Ablack w-[300px] h-[150px] flex flex-col space-y-2 px-4 py-8 text-center screen-w:w-[850px] screen-w:h-[400px] screen-w:px-8 screen-w:py-16 text-Ablack text-xs screen-w:text-4xl font-bold">
    ...
    VI: () => (
        <div className="border-4 border-Ablack w-[300px] h-[150px] flex flex-col space-y-2 px-4 py-8 text-center screen-w:w-[850px] screen-w:h-[450px] screen-w:px-8 screen-w:py-16 text-Ablack text-xs screen-w:text-4xl font-bold">

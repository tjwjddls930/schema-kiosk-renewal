            ...
            <div className="h-screen w-screen bg-Awhite">
                <div className="w-full py-6 px-12 screen-w:py-12 screen-w:px-20 flex flex-row justify-between">
                    <div className="flex flex-row z-10">
                        ...
                        />
                        <span className="text-Cgrey text-base screen-w:text-xl font-bold mt-2">미술관 소개 </span>
                        <span className="text-Cgrey text-base screen-w:text-xl font-bold mt-2">{'> 미술관 소개 및 구조'}</span>
                    </div>
                    <div>

...
const paragraph1 = {
    KOR: (orient) => (
        <p className={clsx(orient ? "text-Cgrey text-sm screen-w:text-5xl font-bold screen-w:leading-snug" : "text-Cgrey text-sm screen-w:text-4xl font-bold screen-w:leading-snug")}>
    ...
    ENG: (orient) => (
        <p className={clsx(orient ? "text-Cgrey text-sm screen-w:text-4xl font-bold screen-w:leading-snug" : "text-Cgrey text-sm screen-w:text-3xl font-bold screen-w:leading-snug")}>
    ...
    TH: (orient) => (
        <p className={clsx(orient ? "text-Cgrey text-sm screen-w:text-4xl font-bold screen-w:leading-snug" : "text-Cgrey text-sm screen-w:text-4xl font-bold screen-w:leading-snug")}>
...
const paragraph2 = {
    KOR: (orient) => (
        <p className={orient ? "text-Cgrey text-sm screen-w:text-5xl font-bold screen-w:leading-snug" : "text-Cgrey text-sm screen-w:text-4xl font-bold screen-w:leading-snug"}>
    ...
    ENG: (orient) => (
        <p className={orient ? "text-Cgrey text-sm screen-w:text-4xl font-bold screen-w:leading-snug" : "text-Cgrey text-sm screen-w:text-3xl font-bold screen-w:leading-snug"}>
    ...
    TH: (orient) => (
        <p className={orient ? "text-Cgrey text-sm screen-w:text-4xl font-bold screen-w:leading-snug" : "text-Cgrey text-sm screen-w:text-4xl font-bold screen-w:leading-snug"}>
...
const paragraph3 = {
    KOR: (orient) => (
        <p className={clsx(orient ? "text-Cgrey text-sm screen-w:text-5xl font-bold screen-w:pt-40 screen-w:leading-snug" : "text-Cgrey text-sm screen-w:text-4xl font-bold screen-w:pt-40 screen-w:leading-snug")}>
    ...
    ENG: (orient) => (
        <p className={clsx(orient ? "text-Cgrey text-sm screen-w:text-4xl font-bold screen-w:pt-40 screen-w:leading-snug" : "text-Cgrey text-sm screen-w:text-3xl font-bold screen-w:pt-40 screen-w:leading-snug")}>
    ...
    TH: (orient) => (
        <p className={clsx(orient ? "text-Cgrey text-sm screen-w:text-4xl font-bold screen-w:pt-40 screen-w:leading-snug" : "text-Cgrey text-sm screen-w:text-4xl font-bold screen-w:pt-40 screen-w:leading-snug")}>
    ...
    VI: (orient) => (
        <p className={clsx(orient  ? "text-Cgrey text-sm screen-w:text-4xl font-bold screen-w:pt-40 screen-w:leading-snug" : "text-Cgrey text-sm screen-w:text-3xl font-bold screen-w:pt-60 screen-w:leading-snug")}>
...
const Schemaintro = () => {
    ...
    return(
        <div className={clsx(isPortrait ? "screen-w:h-full p-6 screen-w:pt-40 screen-w:pl-[370px] mx-auto items-center" : "p-6 screen-w:p-12 mx-auto items-center")}>
            <div className={clsx(isPortrait ? "h-3/4 w-full flex flex-col space-y-8 screen-w:px-8 screen-w:py-6 items-center" : "h-2/3 w-full flex flex-row space-x-8 screen-w:py-8 screen-w:px-6")}>
                {/* 좌측 그림 및 텍스트 */}
                ...
                <div className={clsx(isPortrait ? "h-[30%] w-3/4 flex flex-col space-y-4 mx-auto" : "h-5/6 w-[30%] flex flex-col space-y-4 screen-w:space-y-12 screen-w:px-16")}>
                    ...
                    {circle[language]()}
                    {paragraph2[language](isPortrait)}
                </div>
                <div className={clsx(isPortrait ? "h-[30%] w-3/4 flex flex-row space-x-8" : "h-1/2 w-[30%] flex flex-row space-x-8 screen-w:px-8")}>
                    {paragraph3[language](isPortrait)}
                </div>
                <div className={clsx(isPortrait ? "h-[30%] w-3/4 flex" : "h-1/2 w-[30%] flex screen-w:px-8")}>
                    {paragraph4[language](isPortrait)}
                </div>

                <div className={clsx(isPortrait ? "absolute transform -translate-y-1/2 -translate-x-1/2 left-[64%] top-[84%] screen-w:h-[200px] screen-w:w-[400px]" : "absolute transform -translate-y-1/2 -translate-x-1/2 left-2/3 top-2/3 screen-w:h-[400px] screen-w:w-[800px]")}>
                ...
                <div className={clsx(isPortrait ? "absolute right-4 screen-w:h-[300px] screen-w:w-[750px] screen-w:right-8 transform -translate-y-1/2 top-[85%]" : "absolute right-4 screen-w:h-[500px] screen-w:w-[950px] screen-w:right-8 transform -translate-y-1/2 top-2/3")}>
                    <img

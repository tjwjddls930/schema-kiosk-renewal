...
const paragraph1 = {
    ...
    ENG: () => (
        <p className="text-Cgrey text-sm screen-w:text-3xl font-bold screen-w:leading-snug">
...
const paragraph3 = {
    KOR: () => (
        <p className="text-Cgrey text-sm screen-w:text-4xl font-bold screen-w:pt-40 screen-w:leading-snug">
    ...
    ENG: () => (
        <p className="text-Cgrey text-sm screen-w:text-3xl font-bold screen-w:pt-40 screen-w:leading-snug">
    ...
    VI: () => (
        <p className="text-Cgrey text-sm screen-w:text-3xl font-bold screen-w:pt-60 screen-w:leading-snug">

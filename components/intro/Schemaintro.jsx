        ...
        <div className="h-2/3 w-full flex flex-row space-x-8 2xl:py-8">
            ...
            <div className="h-5/6 w-2/5 flex flex-col space-y-4 2xl:space-y-12 2xl:px-8">
                ...
                <p className="text-Cgrey text-sm 2xl:text-3xl font-bold">
                    ...
                    <span className="text-Cpurple text-sm 2xl:text-3xl">{'충청북도 제 2011-01호 제1종 미술관'}</span> {'이며, 최근 한국박물관협회, 한국과학창의재단, 교육과학기술부로부터'}
                     <span className="text-Cpurple text-sm 2xl:text-3xl">{'박물'}</span>
                ...
                <p className="text-Cgrey text-sm 2xl:text-3xl font-bold">
                    ...
                    <span className="text-Cpurple text-sm 2xl:text-3xl">{'현대미술'}</span>
                    <span className="text-Cpurple text-sm 2xl:text-3xl">{'의 격이 시대정신에 걸 맞는 창작 예술의 연구와 실천을 위한'}</span>
            ...
            <div className="h-1/2 w-2/3 flex flex-row space-x-8">
                <p className="text-Cgrey text-sm 2xl:text-3xl font-bold">
                    ...
                    <span className="text-Cpurple text-sm 2xl:text-3xl">{'다양한 계층의 다양한 문화예술체험 교'}</span>
                    <span className="text-Cpurple text-sm 2xl:text-3xl">{'육기관'}</span>{'으로의 기능을 수행하고자 합니다.'}
                </p>
                <p className="text-Cgrey text-sm 2xl:text-3xl font-bold">
            ...
            <div className="absolute right-64 bottom-56 2xl:right-96 2xl:bottom-96">

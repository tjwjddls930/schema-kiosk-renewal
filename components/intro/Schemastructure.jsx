...
const Schemastructure = () => {
    ...
    return(
        <div className="h-2/3 w-full flex flex-row space-x-2 screen-w:space-x-8 screen-w:pt-6 screen-w:px-8">
            <div className="w-[40%] flex flex-col space-y-2 screen-w:space-y-8 items-center">
                <div className="flex shadow-lg screen-w:w-5/6 screen-w:h-[60%]">
                    <img 
                ...
                <div className="w-[450px] screen-w:w-5/6 flex flex-row mx-auto">
                ...
                <div className="w-[450px] screen-w:w-5/6 flex justify-start">
                    {outsideText[language]()}
                </div>
            </div>
            <div className="grid gap-6 grid-cols-2 screen-w:w-[60%] mx-auto items-center">
                {
                    inputData[language].map((img, index) => (
                        <div 
                            ...
                            <img 
                                ...
                                src={`${img.src}`}
                                alt=""
                                className="h-[120px] w-[320px] shadow-lg screen-w:h-[550px] screen-w:w-[850px] screen-w:mx-auto"
                            />
                            <div

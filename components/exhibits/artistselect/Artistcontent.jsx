    ...
    return (
        ...
        {isClient && (
            <div className="2xl:w-full flex flex-row 2xl:mx-auto">
                <span className="text-8xl w-1/12 2xl:w-2/12 font-bold text-black pl-32 2xl:text-[170px] 2xl:pl-56">{order}</span>
                <div className="flex flex-row h-[180px] 2xl:h-[500px] w-1/2 ml-64 2xl:ml-96 items-center shadow-lg px-8 bg-Awhite mx-auto rounded-lg">
                    <div className="flex flex-col space-y-3 2xl:space-y-8 w-1/4">
                        ...
                        <button className="text-base h-8 w-[120px] 2xl:text-4xl 2xl:h-20 2xl:w-[300px] text-Awhite font-bold rounded-full bg-gradient-to-r from-Agradient to-Bgradient">
                            {/* <Link href="/paint">
                                {'작품 보러가기'}
                            </Link> */}
                    ...
                    <div className="p-2 w-3/4 h-full overflow-auto">
                        <p className="text-black text-base 2xl:text-4xl overflow-auto">
                            {text}
                        </p>
                    </div>
                </div>

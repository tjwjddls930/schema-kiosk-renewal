        ...
        <div className="flex flex-row">
            ...
            <div className="flex flex-row h-[180px] 2xl:h-[220px] w-1/2 ml-64 items-center shadow-lg px-8 bg-Awhite mx-auto rounded-lg">
                <div className="flex flex-col space-y-3 w-1/4">
                    ...
                    <button className="text-base h-8 w-[120px] 2xl:text-lg 2xl:h-10 2xl:w-[150px] text-Awhite font-bold rounded-full bg-gradient-to-r from-Agradient to-Bgradient">
                        <Link href="/paint">
                            {'작품 보러가기'}
                        </Link>
                    </button>

    ...
    return(
        <Pageframe>
            <div className="h-screen w-screen bg-Agrey">
                <div className="w-full py-10 px-16 flex flex-row justify-between">
                    <div className="flex flex-row">
                        <Image 
                            ...
                            priority={true}
                        />
                        <span className="text-Awhite text-xl mt-2">{'전시 안내 '} </span>
                        <span className="text-Awhite text-xl mt-2">{' > 현재 전시'}</span>
                        <span className="text-Awhite text-xl font-bold mt-2">{' > 작가 선택'}</span>
                    </div>
                    <div>
                ...
                <span className="absolute bottom-60 right-28 text-8xl w-1/12 font-bold text-Awhite opacity-50">{'/05'}</span>
            </div>
        </Pageframe>
    )
};
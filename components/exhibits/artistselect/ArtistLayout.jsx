    ...
    return(
        <Pageframe>
            <div className="h-screen w-screen bg-Agrey">
                ...
                <button className="absolute left-32 2xl:left-72 2xl:bottom-36">
                    <Link href="/main">
                        <img 
                ...
                <span className="absolute bottom-56 2xl:bottom-96 right-28 text-8xl 2xl:text-[170px] w-1/12 font-bold text-Awhite opacity-50">{''}</span>
                <Navbar 

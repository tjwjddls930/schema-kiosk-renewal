    ...
    return(
        <Pageframe>
            ...
            <div className="w-full flex flex-row justify-between p-10 font-pretendard_bold">
                    <span className="text-xl 2xl:text-2xl font-bold text-Agrey">
                        {'전시 안내'}
                    </span>
                    <div className="h-[0.5px] flex flex-col mx-auto text-center items-center space-y-8">
                        <span className="text-Ablack font-bold text-xl 2xl:text-3xl">{'스마트 디지털 전시 관람 서비스'}</span>
                        <span className="text-Cgrey font-bold text-lg 2xl:text-xl">{t("MAIN_TOP_2")}</span>
                    </div>
                ...
                {children}
                <div className="absolute transform rotate-90 right-44 bottom-44 2xl:right-36 2xl:bottom-60">

...
export default function Camerabutton() {
    ...
    return<>
        ...
        <div className={
            `absolute bottom-32 w-full h-[80px] 2xl:h-[100px] space-x-2 overflow-hidden cursor-pointer ${exhibit1 ? 'z-[1000]': null}`
        }>
            <div className="flex flex-row">
        ...
        <div className={
            `absolute bottom-32 w-full h-[80px] 2xl:h-[100px] space-x-2 overflow-hidden cursor-pointer ${exhibit2 ? 'z-[1000]' : null}`
        }>
            <div className="flex flex-row">

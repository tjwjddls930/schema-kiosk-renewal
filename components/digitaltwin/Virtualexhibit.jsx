...
const Virtualexhibit = () => {
    ...
    return(
        <>
           <Paintingbox position={[-4, 0.5, 3.65]} rotation={[0, 0, 0]} width={5.5} height={2.5} url={image0} />
           <Paintingbox position={[6.7, 1, 7]} rotation={[0, MathUtils.degToRad(90), 0]} width={5} height={2.5} url={image1} />
            {/* 전시실1 */}
            <Paintingbox position={[2.4, pHeight, -2]} rotation={[0, MathUtils.degToRad(90), 0]} width={1.46} height={1.82} url={image2} />
            <Paintingbox position={[2.4, pHeight, -7]} rotation={[0, MathUtils.degToRad(90), 0]} width={3.24} height={3.24} url={image3} />
            <Paintingbox position={[2.4, pHeight, -12]} rotation={[0, MathUtils.degToRad(90), 0]} width={1.46} height={1.82} url={image4} />
            <Paintingbox position={[12, pHeight, -15.86]} rotation={[0, 0, 0]} width={4} height={5} url={image5} />
